...
data_2014 = read_csv_from_hdfs('/home/paven/Bigdata/Project/W_JFK_LAX_Data_2014', cols, col_types)
data_2015 = read_csv_from_hdfs('/home/paven/Bigdata/Project/W_JFK_LAX_Data_2015', cols, col_types)
...
clf_abc.fit(train_x.toarray(), train_y)

# Evaluate on test set
pr = clf_abc.predict(test_x.toarray())
