...
-- Run this file in ubuntu terminal (or other supporting platforms) as "pig -f dataset2.pig"
...
DEFINE preprocess(year_str, org_airport_code, dest_airport_code) returns data
{
        ...
        airline2 = foreach airline_flt generate YEAR as year, MONTH as month, DAY_OF_MONTH as day, DAY_OF_WEEK as dow,
         ...
         -- load weather data (give the path in your system setup)
...
rmf W_JFK_Data_2011
store Data_2011 into 'W_JFK_Data_2011' using PigStorage(',');

Data_2012 = preprocess('2012', 'JFK', 'LAX');
rmf W_JFK_Data_2012
store Data_2012 into 'W_JFK_Data_2012' using PigStorage(',');

Data_2013 = preprocess('2013', 'JFK', 'LAX');
rmf W_JFK_Data_2013
store Data_2013 into 'W_JFK_Data_2013' using PigStorage(',');

Data_2014 = preprocess('2014', 'JFK', 'LAX');
rmf W_JFK_Data_2014
store Data_2014 into 'W_JFK_Data_2014' using PigStorage(',');

Data_2015 = preprocess('2015', 'JFK', 'LAX');
rmf W_JFK_Data_2015
store Data_2015 into 'W_JFK_Data_2015' using PigStorage(',');