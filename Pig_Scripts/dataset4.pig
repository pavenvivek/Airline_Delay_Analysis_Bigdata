...
-- Run this file in ubuntu terminal (or other supporting platforms) as "pig -f dataset4.pig"
...
DEFINE preprocess(year_str, org_airport_code, dest_airport_code) returns data
{
        ...
        dest_weather_tmin = filter weather by station == 'USW00094846' and metric == 'TMIN';
        dest_weather_tmax = filter weather by station == 'USW00094846' and metric == 'TMAX';
        dest_weather_prcp = filter weather by station == 'USW00094846' and metric == 'PRCP';
        dest_weather_snow = filter weather by station == 'USW00094846' and metric == 'SNOW';
        dest_weather_awnd = filter weather by station == 'USW00094846' and metric == 'AWND';
...
Data_2011 = preprocess('2011', 'JFK', 'ORD');
rmf W_JFK_ORD_Data_2011
store Data_2011 into 'W_JFK_ORD_Data_2011' using PigStorage(',');

Data_2012 = preprocess('2012', 'JFK', 'ORD');
rmf W_JFK_ORD_Data_2012
store Data_2012 into 'W_JFK_ORD_Data_2012' using PigStorage(',');

Data_2013 = preprocess('2013', 'JFK', 'ORD');
rmf W_JFK_ORD_Data_2013
store Data_2013 into 'W_JFK_ORD_Data_2013' using PigStorage(',');

Data_2014 = preprocess('2014', 'JFK', 'ORD');
rmf W_JFK_ORD_Data_2014
store Data_2014 into 'W_JFK_ORD_Data_2014' using PigStorage(',');

Data_2015 = preprocess('2015', 'JFK', 'ORD');
rmf W_JFK_ORD_Data_2015
store Data_2015 into 'W_JFK_ORD_Data_2015' using PigStorage(',');